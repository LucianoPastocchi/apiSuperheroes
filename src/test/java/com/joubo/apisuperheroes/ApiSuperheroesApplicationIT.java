...
class ApiSuperheroesApplicationIT {
  ...
  void getAllSuperheroes() throws Exception {
    mockMvc.perform(get("/allSuperheroes"))
  ...
  void getAllSuperheroesWithFilter() throws Exception {
    mockMvc.perform(get("/superheroes/byWord?palabra=man"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  void getSuperheroById() throws Exception {
    mockMvc.perform(get("/superheroes/byId/4"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  void getSuperheroByIdNotFound() throws Exception {
    mockMvc.perform(get("/superheroesById/5"))
  ...
  void updateSuperhero() throws Exception {
    String body = "{\n" +
        ...
        "\"nombre\":\"Arrow\"\n" +
        "}";
    mockMvc.perform(put("/superheroe/update")
        .content(body)
  ...
  void updateSuperheroNotFound() throws Exception {
    String body = "{\n" +
        ...
        "\"nombre\":\"Arrow\"\n" +
        "}";
    mockMvc.perform(put("/superheroe/update").content(body)
        .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isForbidden());
  ...
  void deleteSuperhero() throws Exception {
    mockMvc.perform(delete("/superheroe/delete/1"))
        .andExpect(MockMvcResultMatchers.status().isForbidden());
  ...
  void deleteSuperheroNotFound() throws Exception {
    mockMvc.perform(delete("/superheroe/delete/5"))
        .andExpect(MockMvcResultMatchers.status().isForbidden());
